...
fish_encounters
fish.wider<- pivot_wider(fish_encounters, names_from= station, values_from=seen)
fish.wider

relig_income
income.longer <- pivot_longer(relig_income, cols=!religion, names_to="income", values_to="count")
```
...
data("Orange")
Orange
ggplot(Orange, aes(x=age, y=circumference )) + geom_point(color = "blue", size=4, shape=4)+ xlab("Age") +ylab("Circumference") + ggtitle("circumverence vs age")+theme(axis.text.x=element_text(angle=45))
...
ggplot(Orange, aes(x=age, y=circumference, color=Tree )) + 
  geom_point(color = "blue", size=4, shape=4)+
  geom_line()+ 
  xlab("Age") +ylab("Circumference") + 
  ggtitle("circumverence vs age")+
  theme_minimal()+
